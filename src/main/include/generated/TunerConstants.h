...
/**
 * @brief Generated by the Tuner X Swerve Project Generator
 * @a https://v6.docs.ctr-electronics.com/en/stable/docs/tuner/tuner-swerve/index.html
 */ 
class TunerConstants {
    // Both sets of gains need to be tuned to your individual robot.

    /**
     * @brief The steer motor uses any SwerveModule.SteerRequestType control request with the
    ...
    /**
     * @brief When using closed-loop control, the drive motor uses the control
    ...
    /**
     * @brief Initial configs for the drive and steer motors and the azimuth encoder; these cannot be null.
     * Some configs will be overwritten; check the `With*InitialConfigs()` API documentation.
     */
    static constexpr configs::TalonFXConfiguration driveInitialConfigs{};

    /**
     * @note Swerve azimuth does not require much torque output, so we can set a relatively low
...
public:
    /**
     * @brief CAN bus that the devices are located on;
     * All swerve devices must share the same CAN bus.
     */
    static inline const CANBus kCANBus{kCANBusName, "./logs/example.hoot"};

    /**
     * @brief Theoretical free speed (m/s) at 12 V applied output;
     * This needs to be tuned to your individual robot.
     * @todo Find this value.
     */
    static constexpr units::meters_per_second_t kSpeedAt12Volts = 4.42_mps;
...
private:
    ...
    static constexpr units::inch_t kWheelRadius = 1.87_in;
...
private:
    ...
    static constexpr units::inch_t kFrontLeftXPos = 14.65_in;
    ...
    static constexpr units::turn_t kFrontRightEncoderOffset = kEncoderOffsets[kFrontRightDriveMotorModuleId - 1];
    static constexpr bool kFrontRightSteerMotorInverted = true;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr units::inch_t kFrontRightXPos = 14.65_in;
    ...
    static constexpr units::turn_t kBackLeftEncoderOffset = kEncoderOffsets[kBackLeftDriveMotorModuleId - 1];
    static constexpr bool kBackLeftSteerMotorInverted = true;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr units::inch_t kBackLeftXPos = -14.65_in;
    ...
    static constexpr units::inch_t kBackRightXPos = -14.65_in;
    static constexpr units::inch_t kBackRightYPos = -14.65_in;
...
public:
    ...
    /**
     * @brief Creates a CommandSwerveDrivetrain instance.
     * @attention This should only be called once in your robot program.
     */
